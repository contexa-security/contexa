...
public class IamXacmlPrpAutoConfiguration {
    ...
    public DatabasePolicyRetrievalPoint databasePolicyRetrievalPoint(PolicyRepository policyRepository) {
        return new DatabasePolicyRetrievalPoint(policyRepository);
    }
}
