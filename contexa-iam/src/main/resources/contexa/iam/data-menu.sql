...
WITH seed(name, url, icon, parent_data_page, menu_order, enabled, menu_type, data_page) AS (
    VALUES
    ('menu.policy.center',           '/admin/policy-center',          '',                'policy',     1,  TRUE, 'CORE',       'policy-center'),
    ('menu.access.center',           '/admin/access-center',          '',                'access',     1,  TRUE, 'CORE',       'access-center'),
    ('menu.iam.users',               '/admin/users',                  '',                'iam',        1,  TRUE, 'CORE',       'users'),
    ('menu.iam.groups',              '/admin/groups',                 '',                'iam',        2,  TRUE, 'CORE',       'groups'),
    ('menu.iam.roles',               '/admin/roles',                  '',                'iam',        3,  TRUE, 'CORE',       'roles'),
    ('menu.iam.permissions',         '/admin/permissions',            '',                'iam',        4,  TRUE, 'CORE',       'permissions'),
    ('menu.iam.role.hierarchies',    '/admin/role-hierarchies',       '',                'iam',        5,  TRUE, 'CORE',       'role-hierarchies'),
    ('menu.iam.password.policy',     '/admin/password-policy',        '',                'iam',        6,  TRUE, 'CORE',       'password-policy'),
    ('menu.iam.system.settings',     '/admin/system-settings',        '',                'iam',        7,  TRUE, 'CORE',       'system-settings'),
    ('menu.iam.menu.management',     '/admin/menu-management',        '',                'iam',        8,  TRUE, 'CORE',       'menu-management'),
    ('menu.zerotrust.monitor',       '/admin/security-monitor',       '',                'security',   1,  TRUE, 'CORE',       'security-monitor'),
    ('menu.zerotrust.blacklist',     '/admin/blacklist',              '',                'security',   2,  TRUE, 'CORE',       'blacklist'),
    ('menu.security.sessions',       '/admin/session-management',     '',                'security',   3,  TRUE, 'CORE',       'session-management'),
    ('menu.security.ip',             '/admin/ip-management',          '',                'security',   4,  TRUE, 'CORE',       'ip-management'),
    ('menu.enterprise.zerotrust',    '/admin/enterprise/zerotrust',   '',                'security',   5,  TRUE, 'ENTERPRISE', 'enterprise-zerotrust'),
    ('menu.enterprise.incidents',    '/admin/enterprise/incidents',   '',                'security',   6,  TRUE, 'ENTERPRISE', 'enterprise-incidents'),
    ('menu.enterprise.home',         '/admin/enterprise',             '',                'enterprise', 1,  TRUE, 'ENTERPRISE', 'enterprise-home'),
    ('menu.enterprise.approvals',    '/admin/enterprise/approvals',   '',                'enterprise', 2,  TRUE, 'ENTERPRISE', 'enterprise-approvals'),
    ('menu.enterprise.mcp',          '/admin/enterprise/mcp',         '',                'enterprise', 3,  TRUE, 'ENTERPRISE', 'enterprise-mcp'),
    ('menu.enterprise.permits',      '/admin/enterprise/permits',     '',                'enterprise', 4,  TRUE, 'ENTERPRISE', 'enterprise-permits'),
    ('menu.enterprise.executions',   '/admin/enterprise/executions',  '',                'enterprise', 5,  TRUE, 'ENTERPRISE', 'enterprise-executions'),
    ('menu.enterprise.playbooks',    '/admin/enterprise/playbooks',   '',                'enterprise', 6,  TRUE, 'ENTERPRISE', 'enterprise-playbooks'),
    ('menu.enterprise.metrics',      '/admin/enterprise/metrics',     '',                'enterprise', 7,  TRUE, 'ENTERPRISE', 'enterprise-metrics'),
    ('menu.enterprise.integration',  '/admin/enterprise/integration', '',                'enterprise', 8,  TRUE, 'ENTERPRISE', 'enterprise-integration'),
    ('프롬프트 품질 보증 엔진',       '/admin/enterprise/verification','fas fa-terminal','enterprise', 9,  TRUE, 'ENTERPRISE', 'enterprise-verification'),
    ('벤치마크',                     '/admin/benchmark',              'fas fa-chart-line','enterprise',10, TRUE, 'ENTERPRISE', 'enterprise-benchmark'),
    ('menu.saas.tenants',            '/admin/saas/tenants',           '',                'saas',       1,  TRUE, 'SAAS',       'saas-platform-tenants'),
    ('menu.saas.billing',            '/admin/saas/billing',           '',                'saas',       2,  TRUE, 'SAAS',       'saas-platform-billing'),
    ('menu.saas.dedicated',          '/admin/saas/dedicated',         '',                'saas',       3,  TRUE, 'SAAS',       'saas-platform-dedicated'),
    ('menu.saas.release.governance', '/admin/saas/release-governance','',                'saas',       4,  TRUE, 'SAAS',       'saas-release-governance'),
    ('menu.saas.tenant.workspace',   '/admin/saas/tenant/workspace',  '',                'saas',       5,  TRUE, 'SAAS',       'saas-tenant-workspace'),
    ('menu.saas.learning',           '/admin/saas/learning/overview', '',                'saas',       6,  TRUE, 'SAAS',       'saas-learning-overview')
),
resolved AS (
