...
public record DecisionBiasAggregationResult(
    ...
    public DecisionBiasAggregationResult {
        ...
        recommendedConfidenceAdjustment = requireFinite(recommendedConfidenceAdjustment, "recommendedConfidenceAdjustment");
    ...
    public static DecisionBiasAggregationResult empty() {
        return new DecisionBiasAggregationResult(0L, 0L, 0L, 0L, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d, "NONE", List.of());
    }
