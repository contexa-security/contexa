...
public class SecurityDecisionStandardPromptTemplate extends AbstractStandardPromptTemplate<SecurityDecisionResponseLite> {
    ...
    public static final PromptGovernanceDescriptor SECURITY_DECISION_PROMPT_GOVERNANCE =
            new PromptGovernanceDescriptor(
                    ...
                    "contexa-cortex-core",
                    "B5-02-D03-TENANT-ISOLATION-2026-07-26-V5",
                    "2026.07.26-b5-v5-gpt-5-nano-tenant-isolation",
                    "2026.07.24-v4",
                    "Zero Trust runtime decision prompt v5 preserves the V2 contract and makes cross-tenant conflicts decisive",
                    List.of(
                            "STRICT_JSON_SCHEMA",
