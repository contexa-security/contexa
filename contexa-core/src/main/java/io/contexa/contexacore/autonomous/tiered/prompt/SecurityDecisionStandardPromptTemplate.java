...
public class SecurityDecisionStandardPromptTemplate extends AbstractStandardPromptTemplate<SecurityDecisionResponseLite> {
    ...
    public static final PromptGovernanceDescriptor SECURITY_DECISION_PROMPT_GOVERNANCE =
            new PromptGovernanceDescriptor(
                    ...
                    "contexa-cortex-core",
                    "B2-10-OFFICIAL-VERIFICATION-2026-07-24-V4",
                    "2026.07.24-b2-v4-gpt-5-nano-certifiable",
                    "2026.07.24-v3",
                    "Zero Trust runtime decision prompt v4 preserves the V2 contract and makes overlapping reasoning requirements deterministic",
                    List.of(
                            "STRICT_JSON_SCHEMA",
