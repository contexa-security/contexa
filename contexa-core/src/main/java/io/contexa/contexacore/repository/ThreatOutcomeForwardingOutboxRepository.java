...
public interface ThreatOutcomeForwardingOutboxRepository extends JpaRepository<ThreatOutcomeForwardingOutboxRecord, Long> {

    Optional<ThreatOutcomeForwardingOutboxRecord> findByOutcomeId(String outcomeId);
    ...
    @Query("""
            ...
            """)
    List<ThreatOutcomeForwardingOutboxRecord> findDispatchable(
