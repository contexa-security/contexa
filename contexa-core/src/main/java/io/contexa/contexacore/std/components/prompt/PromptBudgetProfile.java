...
public enum PromptBudgetProfile {
    ...
    CORTEX_L1_INTERACTIVE_STRICT("CORTEX_L1_INTERACTIVE_STRICT", "Security decision layer1 interactive strict profile", 4200, 260, 3200, 180, true, PromptViewProfile.STANDARD, false),
