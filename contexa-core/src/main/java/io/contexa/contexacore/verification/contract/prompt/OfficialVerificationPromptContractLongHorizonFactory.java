...
final class OfficialVerificationPromptContractLongHorizonFactory {
    ...
    private static final String CHROME_RAW =
    ...
    private OfficialVerificationPromptContractLongHorizonFactory() {
    }

    static List<OfficialVerificationPromptContractRoundPlan> buildResourceSurgeRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        addBaselineSession(rounds, 0, DayOfWeek.MONDAY, 9, 5, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-001",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-002",
        ...
        addBaselineSession(rounds, 0, DayOfWeek.WEDNESDAY, 10, 12, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-003",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-001",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.MONDAY, 9, 4, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-001",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-901",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.WEDNESDAY, 10, 14, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-002",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-902",
                "RESOURCE_SENSITIVITY_SURGE",
    ...
    static List<OfficialVerificationPromptContractRoundPlan> buildResourceFanoutRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, 10 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-021",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-022",
                    "stable sensitive working pair");
            addBaselineSession(rounds, week, DayOfWeek.WEDNESDAY, 10, 18 - week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-023",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-021",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.MONDAY, 9, 12, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-021",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-071",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.WEDNESDAY, 10, 16, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-022",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-072",
                "UNSEEN_RESOURCE_FANOUT",
    ...
    static List<OfficialVerificationPromptContractRoundPlan> buildDeviceShiftRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, 8 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-031",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-032",
            ...
            addBaselineSession(rounds, week, DayOfWeek.WEDNESDAY, 10, 20 - week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-033",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-031",
    ...
    static List<OfficialVerificationPromptContractRoundPlan> buildNetworkPivotRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, 7 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-041",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-042",
                    "corp LAN baseline");
            addBaselineSession(rounds, week, DayOfWeek.WEDNESDAY, 10, 21 - week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-043",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-041",
    ...
    static List<OfficialVerificationPromptContractRoundPlan> buildCadenceBurstRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-051",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-052",
    ...
    static List<OfficialVerificationPromptContractRoundPlan> buildSequenceReversalRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, 9 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-061",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-061",
            ...
            addBaselineSession(rounds, week, DayOfWeek.WEDNESDAY, 10, 17 - week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-062",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-062",
            ...
            addBaselineSession(rounds, week, DayOfWeek.FRIDAY, 14, 15 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-063",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-063",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.MONDAY, 9, 10, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-061",
                "/admin/api/enterprise/verification/runtime/probe/normal/resource-061",
                "SEQUENCE_REVERSAL",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.WEDNESDAY, 10, 18, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-062",
                "/admin/api/enterprise/verification/runtime/probe/normal/resource-062",
                "SEQUENCE_REVERSAL",
    ...
    static List<OfficialVerificationPromptContractRoundPlan> buildLateEscalationRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, 4 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-071",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-071",
            ...
            addBaselineSession(rounds, week, DayOfWeek.WEDNESDAY, 10, 13 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-072",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-072",
            ...
            addBaselineSession(rounds, week, DayOfWeek.FRIDAY, 14, 7 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-073",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-071",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.MONDAY, 9, 5, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-073",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-771",
                "LATE_CRITICAL_APPROVAL",
                "critical approval occurs only after a broad baseline exists");
        addAnomalySession(rounds, 3, DayOfWeek.WEDNESDAY, 10, 14, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/normal/resource-072",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-772",
                "LATE_CRITICAL_APPROVAL",
    ...
    static List<OfficialVerificationPromptContractRoundPlan> buildRecoveryRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, 6 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "managed-vdi",
                    "/admin/api/enterprise/verification/runtime/probe/critical/resource-081",
                    "/admin/api/enterprise/verification/runtime/probe/critical/resource-082",
            ...
            addBaselineSession(rounds, week, DayOfWeek.WEDNESDAY, 10, 22 - week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "managed-vdi",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-081",
                    "/admin/api/enterprise/verification/runtime/probe/critical/resource-083",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.MONDAY, 9, 7, CORP_LAN_IP, CHROME_VDI_RAW, CHROME_VDI_LABEL, "managed-vdi",
                "/admin/api/enterprise/verification/runtime/probe/normal/resource-081",
                "/admin/api/enterprise/verification/runtime/probe/normal/resource-082",
    ...
    static List<OfficialVerificationPromptContractRoundPlan> buildSparseEvidenceRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, 11 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-" + (111 + week),
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-" + (121 + week),
            ...
            addBaselineSession(rounds, week, DayOfWeek.THURSDAY, 15, 6 + week, CORP_WIFI_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-" + (131 + week),
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-" + (141 + week),
        ...
        addAnomalySession(rounds, 3, DayOfWeek.MONDAY, 9, 13, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-151",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-951",
                "SPARSE_EVIDENCE",
        ...
        addRecoverySession(rounds, 3, DayOfWeek.THURSDAY, 15, 9, CORP_WIFI_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/normal/resource-133",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-143",
                "returns to rotating sparse workflow after ambiguity");
        return List.copyOf(rounds);
    }

    static List<OfficialVerificationPromptContractRoundPlan> buildConflictingContextRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, 14 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-161",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-162",
            ...
            addBaselineSession(rounds, week, DayOfWeek.WEDNESDAY, 10, 9 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-163",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-161",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.WEDNESDAY, 10, 10, BRANCH_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-163",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-963",
                "CONFLICTING_CONTEXT",
    ...
    static List<OfficialVerificationPromptContractRoundPlan> buildPartialMemoryRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 9, 2 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-" + (171 + week),
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-" + (181 + week),
            ...
            addBaselineSession(rounds, week, DayOfWeek.WEDNESDAY, 10, 4 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-" + (191 + week),
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-" + (201 + week),
            ...
            addBaselineSession(rounds, week, DayOfWeek.FRIDAY, 14, 5 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-" + (211 + week),
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-" + (221 + week),
        ...
        addAnomalySession(rounds, 3, DayOfWeek.MONDAY, 9, 3, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-171",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-971",
                "PARTIAL_MEMORY",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.WEDNESDAY, 10, 5, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-201",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-972",
                "PARTIAL_MEMORY",
        ...
        addRecoverySession(rounds, 3, DayOfWeek.FRIDAY, 14, 6, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-223",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-211",
                "falls back into the dispersed but familiar path family");
        return List.copyOf(rounds);
    }

    static List<OfficialVerificationPromptContractRoundPlan> buildApprovalAmbiguityRounds() {
        ArrayList<OfficialVerificationPromptContractRoundPlan> rounds = new ArrayList<>();
        for (int week = 0; week < 3; week++) {
            addBaselineSession(rounds, week, DayOfWeek.MONDAY, 8, 58 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-231",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-231",
            ...
            addBaselineSession(rounds, week, DayOfWeek.WEDNESDAY, 10, 2 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-232",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-232",
            ...
            addBaselineSession(rounds, week, DayOfWeek.FRIDAY, 14, 3 + week, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                    "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-233",
                    "/admin/api/enterprise/verification/runtime/probe/normal/resource-231",
                    "scope summary stays broad but approval lineage remains thin");
        }
        addAnomalySession(rounds, 3, DayOfWeek.MONDAY, 9, 1, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/sensitive/resource-233",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-981",
                "APPROVAL_AMBIGUITY",
        ...
        addAnomalySession(rounds, 3, DayOfWeek.WEDNESDAY, 10, 6, CORP_LAN_IP, CHROME_RAW, CHROME_LABEL, "corp-laptop-a",
                "/admin/api/enterprise/verification/runtime/probe/normal/resource-232",
                "/admin/api/enterprise/verification/runtime/probe/critical/resource-982",
                "APPROVAL_AMBIGUITY",
    ...
    private static void addBaselineSession(
            List<OfficialVerificationPromptContractRoundPlan> rounds,
            int week,
            DayOfWeek dayOfWeek,
            int hour,
            int minute,
        ...
        rounds.add(round(rounds.size() + 1, firstPath, clientIp, browserUserAgent, simulatedUserAgentLabel, deviceAlias,
                start, OfficialVerificationPromptContractSessionMode.NEW_SESSION, STEADY_GAP, "BASELINE", "NONE", note,
        ...
        rounds.add(round(rounds.size() + 1, secondPath, clientIp, browserUserAgent, simulatedUserAgentLabel, deviceAlias,
                start.plusMinutes(12), OfficialVerificationPromptContractSessionMode.REUSE_SESSION, SLOW_GAP, "BASELINE", "NONE", note,
    ...
    private static void addAnomalySession(
        ...
        OffsetDateTime start = at(week, dayOfWeek, hour, minute);
        rounds.add(round(rounds.size() + 1, firstPath, clientIp, browserUserAgent, simulatedUserAgentLabel, deviceAlias,
                start, OfficialVerificationPromptContractSessionMode.NEW_SESSION, STEADY_GAP, "ANOMALY", anomalySignal, note,
                List.of("EXPECT_HISTORY_CONTRAST", "EXPECT_MULTI_SESSION_BASELINE", "EXPECT_OBSERVED_WORK_PATTERN")));
        rounds.add(round(rounds.size() + 1, secondPath, clientIp, browserUserAgent, simulatedUserAgentLabel, deviceAlias,
                start.plusMinutes(12), OfficialVerificationPromptContractSessionMode.REUSE_SESSION, BURST_GAP, "ANOMALY", anomalySignal, note,
    ...
    private static void addRecoverySession(
        ...
        OffsetDateTime start = at(week, dayOfWeek, hour, minute);
        rounds.add(round(rounds.size() + 1, firstPath, clientIp, browserUserAgent, simulatedUserAgentLabel, deviceAlias,
                start, OfficialVerificationPromptContractSessionMode.NEW_SESSION, STEADY_GAP, "RECOVERY", "NONE", note,
                List.of("EXPECT_HISTORY_PRESERVATION", "EXPECT_RECOVERY_AFTER_ANOMALY", "EXPECT_RAG_ACCUMULATION")));
        rounds.add(round(rounds.size() + 1, secondPath, clientIp, browserUserAgent, simulatedUserAgentLabel, deviceAlias,
                start.plusMinutes(12), OfficialVerificationPromptContractSessionMode.REUSE_SESSION, STEADY_GAP, "RECOVERY", "NONE", note,
                List.of("EXPECT_HISTORY_PRESERVATION", "EXPECT_PREVIOUS_PATH", "EXPECT_RAG_ACCUMULATION")));
    }

    private static OfficialVerificationPromptContractRoundPlan round(
            int roundNumber,
            String requestPath,
            String clientIp,
            String browserUserAgent,
        ...
        return new OfficialVerificationPromptContractRoundPlan(
    ...
    private static void tweakLastRound(List<OfficialVerificationPromptContractRoundPlan> rounds, OffsetDateTime observedAt, long cooldownBeforeRoundMs) {
        OfficialVerificationPromptContractRoundPlan previous = rounds.get(rounds.size() - 1);
        rounds.set(rounds.size() - 1, new OfficialVerificationPromptContractRoundPlan(
                previous.roundKey(),
