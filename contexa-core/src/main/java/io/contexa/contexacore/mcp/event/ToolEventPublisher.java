package io.contexa.contexacore.mcp.event;

import io.contexa.contexacore.autonomous.authorization.ApprovalWorkflow;
import io.contexa.contexacore.mcp.tool.execution.ToolExecutor;
...
public class ToolEventPublisher {
    ...
    public void publishApprovalRequested(
            ...
            ToolExecutor.ToolRequest request,
            ToolExecutor.ExecutionContext context,
            ApprovalWorkflow.RiskLevel riskLevel) {
