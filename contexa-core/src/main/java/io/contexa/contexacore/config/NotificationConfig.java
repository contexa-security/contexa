...
public class NotificationConfig {
    ...
    public static class NotificationTargetManager {
        private final java.util.Map<String, io.contexa.contexacore.soar.notification.NotificationTarget> targets = 
            new java.util.concurrent.ConcurrentHashMap<>();
        
        /**
         * 타겟 등록
         */
        public void registerTarget(io.contexa.contexacore.soar.notification.NotificationTarget target) {
         ...
         * 타겟 조회
         */
        public io.contexa.contexacore.soar.notification.NotificationTarget getTarget(String targetId) {
         ...
         * 역할별 타겟 조회
         */
        public java.util.List<io.contexa.contexacore.soar.notification.NotificationTarget> getTargetsByRole(String role) {
         ...
         * 온라인 타겟 조회
         */
        public java.util.List<io.contexa.contexacore.soar.notification.NotificationTarget> getOnlineTargets() {
            return targets.values().stream()
                    .filter(io.contexa.contexacore.soar.notification.NotificationTarget::isOnline)
                    .toList();
        }
        ...
        public void updateWebSocketSession(String targetId, String sessionId, boolean online) {
            io.contexa.contexacore.soar.notification.NotificationTarget target = targets.get(targetId);
            if (target != null) {
        ...
        public void initializeDefaultTargets() {
            // 기본 관리자 타겟
            io.contexa.contexacore.soar.notification.NotificationTarget adminTarget = 
