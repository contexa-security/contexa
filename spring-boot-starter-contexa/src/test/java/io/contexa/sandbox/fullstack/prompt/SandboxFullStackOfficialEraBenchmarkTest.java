...
class SandboxFullStackOfficialEraBenchmarkTest extends AbstractSandboxFullStackRealLlmDecisionBenchmarkTest {

    @Test
    @DisplayName("실제 LLM reasoning replay로 ERA 제출 산출물을 생성해야 한다")
    void shouldProduceOfficialEraArtifacts() {
        List<SandboxDecisionBenchmarkRunResult> runResults = executeMetric(SandboxDecisionMetric.ERA);
