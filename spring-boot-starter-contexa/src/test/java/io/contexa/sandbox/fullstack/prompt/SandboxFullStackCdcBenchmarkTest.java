...
class SandboxFullStackCdcBenchmarkTest {
    ...
    @Test
    @DisplayName("CDC 전용 장기 웹 replay는 독립 산출물로 decision calibration 지표를 남겨야 한다")
    void shouldProduceDedicatedCdcArtifactsFromLongHorizonReplay() {
        ...
        reportWriter.write(SandboxDecisionMetric.CDC, runResults);
