...
class SandboxFullStackSuhrBenchmarkTest {
    ...
    @Test
    @DisplayName("SUHR 전용 장기 웹 replay는 안전한 불확실성 처리 지표를 독립 산출물로 남겨야 한다")
    void shouldProduceDedicatedSuhrArtifactsFromLongHorizonReplay() {
        ...
        reportWriter.write(SandboxDecisionMetric.SUHR, runResults);
