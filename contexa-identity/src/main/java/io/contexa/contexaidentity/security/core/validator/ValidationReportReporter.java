...
public class ValidationReportReporter {
    ...
    private static final String INFO_TITLE = "[ DSL Security Configuration Validation Complete ]";

    private static final String ERROR_PREFIX = "  [ERROR] ";
    private static final String WARNING_PREFIX = "  [WARNING] ";
    private static final String FIX_PREFIX = "    >> Suggestion: ";
    ...
    public static void reportAndPotentiallyExit(ValidationResult result, String dslSourceName) throws DslConfigurationException {
        ...
        if (hasErrors) {
            ...
            reportBuilder.append("-----------------------------------------------------------------------------------------\n");
            reportBuilder.append("  All DSL security configurations are valid.\n");
        }
